        ...
        <div className="grid w-full mx-auto grid-cols-4 gap-2">
          <div className="flex items-start flex-col gap-2">
            ...
            <p className="text-zinc-700 leading-relaxed">
              At <span className="font-medium italic">Contour Expeditions Pvt. Ltd.</span>, we specialize in
              crafting unforgettable Mountaineering and Trekking experiences in
              the capital of mountains. Join us for an adventure of a lifetime
            ...
            <button
              type="button"
              className="bg-yellow-200 mt-4 text-center w-48 rounded-3xl h-14 relative font-sans text-black text-xl font-semibold group"
            >
