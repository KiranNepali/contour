      ...
      <div className="w-11/12 relative md:w-10/12 mx-auto py-[5rem]">
        ...
        <div className="w-full flex flex-col gap-5 justify-start items-start">
          ...
          <Image
            ...
            className="w-[70%] mx-auto h-[60vh] rounded-3xl object-cover object-top"
          />
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="w-full md:w-[70%] relative h-[30vh] mx-auto flex justify-center items-center">
              {/* mask */}
              <div className="absolute top-0 left-0 w-full rounded-3xl h-full bg-black opacity-[0.3] z-10"></div>
              <Image
                width={1000}
                height={1000}
