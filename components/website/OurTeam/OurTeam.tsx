  ...
  return (
    <div className="pb-[5rem] w-full">
      <div className="w-full md:w-[70%] pb-[5rem] mx-auto flex flex-col gap-5">
        <h1 className="text-6xl text-center relative tracking-wide mt-10 title font-bold text-secondary-500">
          MADE FOR CLIMBERS
        </h1>
        ...
        {TeamData.map((teamMember, index) => (
          ...
          >
            <div className="w-full justify-between flex px-2">
              <span className="font-sm uppercase tracking-wide font-semibold title">
                {teamMember.name}
              </span>
            ...
            <div className="relative group h-[50vh] rounded-3xl overflow-hidden cursor-pointer">
